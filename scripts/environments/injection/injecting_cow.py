"""
Script to run an environment with a cow and robot
...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts\environments\injection\injecting_cow.py --num_envs 32
...
class GripperState:
    """States for the End Effector Soon will be using Injection."""
...
# This takes in two vectors anmd see diff if it less than threshold than true if not fals
